...
const EducatorClassInstanceSchema = new mongoose.Schema({
  educatorId: { type: mongoose.Types.ObjectId, ref: 'User', required: true, trim: true, max: 50 },
  classInstanceId: { type: mongoose.Types.ObjectId, ref: 'ClassInstance', required: true, trim: true, max: 50 },
});
