...
const EducatorClassInstanceSchema = new mongoose_1.default.Schema({
    educatorId: { type: mongoose_1.default.Types.ObjectId, ref: 'User', required: true, trim: true, max: 50 },
    classInstanceId: { type: mongoose_1.default.Types.ObjectId, ref: 'ClassInstance', required: true, trim: true, max: 50 },
});
